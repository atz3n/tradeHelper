this.PluginsPlTrailingStopOutDetailsPlTrailingStopOutController = RouteController.extend({
	template: "Plugins",
	

	yieldTemplates: {
		'PluginsPlTrailingStopOutDetailsPlTrailingStopOut': { to: 'PluginsSubcontent'}
