...
function KrakenClient(key, secret, otp) {
	...
	function publicMethod(method, params, callback) {
		...
		return rawRequestGet(url, {}, params, callback);
	}
	...
	function privateMethod(method, params, callback) {
		...
		return rawRequestPost(url, headers, params, callback);
	}
	 ...
	 * @return {Object}            The request object
	 */
	function rawRequestGet(url, headers, params, callback) {
	 ...
	 * @return {Object}            The request object
	 */
	function rawRequestPost(url, headers, params, callback) {
		// Set custom User-Agent string
		headers['User-Agent'] = 'Kraken Javascript API Client';
