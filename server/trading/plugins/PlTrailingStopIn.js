 ...
 * @type {Object}
 */
PlTrailingStopIn.ConfigDefault = {
    id: 'undefined',
    name: 'undefined',
...
export function PlTrailingStopIn(logger) {
     ...
     * @type {Object}
     */
    var _config = Object.assign({}, PlTrailingStopIn.ConfigDefault);
    ...
    this.setConfig = function(configuration) {
        _logPreMsg = 'PlTrailingStopIn ' + configuration.id + ': ';
    ...
    this.getConfig = function() {
        ...
        return [
            ...
            { title: 'Threshold Value', value: _config.thresholdValue },
    ...
    this.update = function(price) {
        if (_active) {
            ...
            if (_config.enLong) {
                ...
                if (diff > _config.thresholdValue) _thrshldCntLong++;
                else _thrshldCntLong = 0;

                if (_thrshldCntLong >= _config.thresholdExceedings) {
            ...
            if (_config.enShort) {
                ...
                if (diff < -_config.thresholdValue) _thrshldCntShort++;
                else _thrshldCntShort = 0;

                if (_thrshldCntShort >= _config.thresholdExceedings) {
    ...
    this.getInstInfo = function() {
        ...
        return { id: _config.id, name: _config.name, type: "PlTrailingStopIn" };
    }
